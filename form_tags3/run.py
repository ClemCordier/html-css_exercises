...
correct_answers = 0
student_answer_q1 = input.get_input("select")
student_answer_q2 = input.get_input("textarea")

input.parse_template("template_q1.html")
input.parse_template("template_q2.html")

raw_student_answers = {"select": [student_answer_q1, False], "textarea": [student_answer_q2, False]}

validation_errors_q1 = nu_checker_validation("template_q1.html", task="select", offset=7)
validation_errors_q2 = nu_checker_validation("template_q2.html", task="textarea", offset=7)

validation_errors = {"select": validation_errors_q1, "textarea": validation_errors_q2}
